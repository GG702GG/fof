...
if text == 'اكرهك' then  if not faederdx1:get(FAEDER..'bot:rep:mute'..msg.chat_id_) then local faedero = { "ي تافه","شعور متبادل ي زق الزق" } faederdx121 = math.random(#faedero) faederdx(msg.chat_id_, msg.id_, 1, faedero[faederdx121] , 1, 'md') end end
