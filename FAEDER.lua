...
if text == 'احوبك' then  if not faederdx1:get(FAEDER..'bot:rep:mute'..msg.chat_id_) then local faeder = { "كذاب","اموت فيك صدقني" } faederdx12 = math.random(#faeder) faederdx(msg.chat_id_, msg.id_, 1, faeder[faederdx12] , 1, 'md') end end
if text == 'احبك' or text == 'لفيو' or text == 'احبكك' or text == 'احبككك' or text == 'احبكككك' or text == 'احبككككك' or text == 'ياخي احبك' or text == 'احب' or text == 'احبككككككككك' then if not faederdx1:get(FAEDER..'bot:rep:mute'..msg.chat_id_) then  local faeder = {"‏احببتُك بطريقه لا يعرفها غيري .","وخالقي احببتك أكثر من الحب .","احببتك بقلب باع الجميع وأكتفى بك .","احببتك حتى انني بت اراك الجميع"} faederdx12 = math.random(#faeder) faederdx(msg.chat_id_, msg.id_, 1, faeder[faederdx12] , 1, 'md') faederdx(msg.chat_id_, msg.id_, 1, faeder, 1, 'md') end end
...
if text == 'بوت' and faeder11(msg) then  name_bot = (faederdx1:get('faeder:'..bot_id..'name_bot') or 'لاكس')  local faeder = {'ماني راد عليك الا لمن تناديني بأسمي .','يالبى الي يقول بوت ي ناس .','صوتك وانت تنادي جبر خاطر ! .','ياعمر البوت انت .'}  faeder2 = math.random(#faeder) faederdx(msg.chat_id_, msg.id_, 1, faeder[faeder2] , 1, 'md')  end
...
send_inline(msg.chat_id_,'لاكسس ',nil,inline) 
return false 
end
--     By Developer Faeder     -- 
